/**
 * Tests for /api/categories/[country] endpoint
 *
 * Critical API route - tests category fetching, authentication, and error handling
 */
...
describe('/api/categories/[country]', () => {
  ...
  describe('Happy Path', () => {
    it('should return categories for valid country', async () => {
  ...
  describe('MercadoLibre API Errors', () => {
    it('should handle Categories API 404 error', async () => {
      // Override Categories API to return 404
      server.use(
        http.get('https://api.mercadolibre.com/sites/:siteId/categories', () => {
          return HttpResponse.json(
    ...
    it('should handle Categories API 500 error', async () => {
      // Override Categories API to return 500
      server.use(
        http.get('https://api.mercadolibre.com/sites/:siteId/categories', () => {
          return HttpResponse.json(
    ...
    it('should handle Categories API 401 unauthorized', async () => {
      // Override Categories API to return 401
      server.use(
        http.get('https://api.mercadolibre.com/sites/:siteId/categories', () => {
          return HttpResponse.json(
    ...
    it('should handle Categories API network error', async () => {
      // Override Categories API to throw network error
      server.use(
        http.get('https://api.mercadolibre.com/sites/:siteId/categories', () => {
          return HttpResponse.error();
        })
